...
internal class ModelClassGenerator(
    ...
    companion object {
        ...
        val STATE_DELEGATE_INPUT = MemberName("io.github.e1turin.circulator.state", "input")
        val STATE_DELEGATE_OUTPUT = MemberName("io.github.e1turin.circulator.state", "output")
...
internal fun generateFileSpec(modelInfo: ModelInfo, packageName: String, settings: GeneratorSettings.() -> Unit = {}): FileSpec {
    ...
    val gen = ModelClassGenerator(
        modelInfo,
        settings.openModelClass,
        settings.openLibraryClass,
        settings.internalStateProjections,
        settings.allStateProjectionsOpen,
        settings.allStateProjectionsMutable
    )
    return gen.generateFileSpec(packageName)
}
